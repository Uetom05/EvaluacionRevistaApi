...
import com.example.evrevistaapi.ListaArticulos;
import com.example.evrevistaapi.Models.Volumen;
import com.example.evrevistaapi.R;

import java.util.List;

public class AdapterVolumen extends RecyclerView.Adapter<AdapterVolumen.VolumenViewHolder> {
    private Context context;
    private List<Volumen> lstVolumenes;
    public AdapterVolumen(Context mCtx, List<Volumen> volumenes) {
